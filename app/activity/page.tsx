...
export default function ActivityPage() {
  ...
  const activities = [
    // 个人质押类活动
    {
      id: 1,
      title: "个人质押奖励",
      subtitle: "累计质押奖励、质押量排名奖励、阶段性新增质押排名奖励",
      status: "活动进行中",
      date: "长期有效",
    ...
    // 推荐类活动
    {
      id: 2,
      title: "推荐奖励",
      subtitle: "拉新推荐奖励、累计推荐排名奖励、阶段性推荐新增排名奖励",
      status: "活动进行中",
      date: "长期有效",
    ...
    // 社区类活动
    {
      ...
      title: "社区奖励",
      subtitle:
        "社区阶段性目标达成奖励、社区业绩排名奖、阶段性工作室新增业绩排名奖励",
      status: "活动进行中",
      date: "长期有效",
  ...
  const participationRecords = [
    {
      ...
      rewardAmount: "500 APEX",
      status: "已获得",
      description: "累计质押达到50,000 APEX",
    },
    {
      id: 2,
      activityName: "推荐奖励",
      participateDate: "2024-12-18",
      rewardAmount: "300 APEX",
      status: "已获得",
      description: "成功邀请5位新用户完成质押",
    },
    {
      id: 3,
      activityName: "社区奖励",
      ...
      status: "已获得",
      description: "社区达成Q4目标，全员共享奖励",
    },
    {
      id: 4,
      activityName: "个人质押奖励",
      participateDate: "2024-12-19",
      rewardAmount: "800 APEX",
      status: "待发放",
      description: "11月质押量排名第8名",
    },
    {
      id: 5,
      activityName: "推荐奖励",
      participateDate: "2024-12-17",
      rewardAmount: "400 APEX",
      status: "已获得",
      description: "累计推荐人数排名第12名",
    },
  ];
